...
import (
	...
	apiserver "github.com/moby/moby-core/api/server"
	buildbackend "github.com/moby/moby-core/api/server/backend/build"
	"github.com/moby/moby-core/api/server/middleware"
	"github.com/moby/moby-core/api/server/router"
	"github.com/moby/moby-core/api/server/router/build"
	checkpointrouter "github.com/moby/moby-core/api/server/router/checkpoint"
	"github.com/moby/moby-core/api/server/router/container"
	distributionrouter "github.com/moby/moby-core/api/server/router/distribution"
	"github.com/moby/moby-core/api/server/router/image"
	"github.com/moby/moby-core/api/server/router/network"
	pluginrouter "github.com/moby/moby-core/api/server/router/plugin"
	sessionrouter "github.com/moby/moby-core/api/server/router/session"
	swarmrouter "github.com/moby/moby-core/api/server/router/swarm"
	systemrouter "github.com/moby/moby-core/api/server/router/system"
	"github.com/moby/moby-core/api/server/router/volume"
	"github.com/moby/moby-core/builder/dockerfile"
	"github.com/moby/moby-core/builder/fscache"
	"github.com/moby/moby-core/cli/debug"
	"github.com/moby/moby-core/daemon"
	"github.com/moby/moby-core/daemon/cluster"
	...
	dopts "github.com/moby/moby-core/opts"
	"github.com/moby/moby-core/pkg/authorization"
	"github.com/moby/moby-core/pkg/jsonlog"
	"github.com/moby/moby-core/pkg/listeners"
	"github.com/moby/moby-core/pkg/pidfile"

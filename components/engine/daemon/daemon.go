...
import (
	...
	_ "github.com/moby/moby-core/daemon/graphdriver/register"
	"github.com/moby/moby-core/daemon/initlayer"
	"github.com/moby/moby-core/daemon/stats"
	dmetadata "github.com/moby/moby-core/distribution/metadata"
	...
	volumedrivers "github.com/moby/moby-core/volume/drivers"
	"github.com/moby/moby-core/volume/local"
	"github.com/moby/moby-core/volume/store"
...
func (daemon *Daemon) restore() error {
	...
	for id, c := range containers {
		...
		// Fixes https://github.com/moby/moby-core/issues/22536

...
import (
	...
	"github.com/moby/moby-core/daemon/graphdriver/overlayutils"
	"github.com/moby/moby-core/daemon/graphdriver/quota"
	"github.com/moby/moby-core/pkg/archive"
	"github.com/moby/moby-core/pkg/chrootarchive"
	"github.com/moby/moby-core/pkg/directory"
	"github.com/moby/moby-core/pkg/fsutils"
...
func (d *Driver) Get(id string, mountLabel string) (s string, err error) {
	...
	// See https://github.com/moby/moby-core/issues/27384
	if pageSize > 4096 {
		pageSize = 4096
	}
